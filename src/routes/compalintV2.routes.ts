...
.post('/create/complaint', uploadsMulter.single('uploads'), validateApiKey, RBACMiddelware.validateRole([RoleEnum.Partner]), AuthenticatedController(ComplaintController.createComplaint))
